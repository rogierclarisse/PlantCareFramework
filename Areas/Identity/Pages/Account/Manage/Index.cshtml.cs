...
namespace PlantCareFramework.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user.FirstName != Input.FirstName || user.LastName != Input.LastName || user.LanguageId != Input.LanguageId)
            {
                user.FirstName = Input.FirstName;
                user.LastName = Input.LastName;
                user.Language = _context.Language.FirstOrDefault(l => l.Id == Input.LanguageId);
