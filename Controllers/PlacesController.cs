...
namespace PlantCareFramework.Controllers
{
    ...
    public class PlacesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Inside,Outside")] Place place)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(char id, [Bind("Id,Inside,Outside")] Place place)
        {
            if (id != place.Id)
            {
                return NotFound();
        ...
        private bool PlaceExists(char id)
        {
